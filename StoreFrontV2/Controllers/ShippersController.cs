...
namespace StoreFrontV2.Controllers
{
    public class ShippersController : Controller
    {
        ...
        public ShippersController(StoreFrontContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ShipperId,ShipperName,City,State,Country")] Shipper shipper)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShipperId,ShipperName,City,State,Country")] Shipper shipper)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreFrontContext.Shippers'  is null.");
            }
            var shipper = await _context.Shippers.FindAsync(id);
            if (shipper != null)
            {
